//todo blur pages on clicking a link
...
$(function () {
	...
	$ ("#homePage a:contains('Home')").parent().addClass('active'); //if page # is home, and an a tag contains "Home" add active class to parent (li) tag
	$ ("#aboutusPage a:contains('About Us')").parent().addClass('active');
	$ ("#searchPage a:contains('Search')").parent().addClass('active');
	$ ("#ContactPage a:contains('Contact Us')").parent().addClass('active');
	$ ("#testimonialPage a:contains('Testimonials')").parent().addClass('active');
